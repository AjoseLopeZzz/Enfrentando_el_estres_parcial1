  ...
  if (list.length === 0) {
    ...
    const element = String.raw`
			<div class="ui icon warning message">
				...
				<div class="content">
					<div class="header">Hoy no tienes ninguna tarea!</div>
					<div>Ingrese sus tareas de hoy arriba.</div>
				</div>
			</div>
		`;
...
function addTask(event) {
  ...
  showNotification("success", "La tarea fue agregada exitosamente");
  showTasksList();
}
...
function removeTask(id) {
  ...
  showNotification("error", "La tarea se eliminó correctamente");
  showTasksList();
}
